...
using namespace std;
ifstream file("in.cpp");		// File to get Code
ofstream file2("tokens.txt");		// File to get Result as Tokens

bool isKeyword(char buffer[]){
	char keywords[37][10] = {"main","auto","break","case","char","const","continue","default",
							"do","double","else","enum","extern","float","for","goto",
							"if","int","long","register","return","short","signed",
							"sizeof","static","struct","switch","typedef","union",
							"unsigned","void","volatile","while","cout" , "cin","include","iostream"};
	int i;
	bool flag = false;
	for(i = 0; i < 37; ++i){
